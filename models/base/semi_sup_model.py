...
class SemiSupModel(pl.LightningModule):
    ...
    def __init__(self, params):
        ...
        for k, v in state_dict.items():
            if k.startswith("online_encoder."):
                sd[k.replace("online_encoder.", "")] = v
        self.model.load_state_dict(sd, strict=True)

        # Data
        self.train_transform = utils.SemiSupDataAugmentation(params)
    ...
    def configure_optimizers(self):
        optimizer = torch.optim.SGD(params=list(self.classifier.parameters()) + list((self.model.parameters())),
