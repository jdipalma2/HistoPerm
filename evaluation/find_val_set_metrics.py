...
if hparams.dataset_name == "dhmc_cd":
    hparams.data_path = Path("/workspace/jdipalma/DHMC_Data/CD/val")
    ...
    hparams.data_path = Path("/workspace/jdipalma/DHMC_Data/RCC/val")
    # Per-channel mean and standard deviation.
    ...
    hparams.data_path = Path("/workspace/jdipalma/DHMC_Data/LUAD/val")
    # Per-channel mean and standard deviation.
